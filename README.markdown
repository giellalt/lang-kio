...
This directory contains source files for the Kiowa language morphology
...
In order to compile and use Kiowa language morphology and dictionaries,
you need:
...
The Kiowa language sources can be acquired using [giella SVN

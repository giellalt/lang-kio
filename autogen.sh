...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_kio to login script."
...
# the current dir:
if   test x${GTLANG_kio} = x ; then
	echo "WARNING: The variable \${GTLANG_kio} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_kio} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_kio} has the value:"
	echo "  ${GTLANG_kio}"
